                ...
                <div className="grid grid-cols-12 gap-4 md:gap-8">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className={`col-span-12 ${service.col.includes('md:col-span') ? service.col.split(' ').filter(c => c.startsWith('md:')).join(' ') : ''} group relative overflow-hidden rounded-2xl md:rounded-[2rem] border border-white/5 bg-white/[0.02] p-6 md:p-12 transition-colors duration-300 hover:bg-white/[0.05] hover:border-white/10`}
                        >
