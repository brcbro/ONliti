...
export default async function ServicePage({ params }: Props) {
    ...
    return (
        <main className="bg-[#050505] overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section className="relative min-h-[70vh] md:min-h-[80vh] flex flex-col justify-center items-center text-center px-5 md:px-8 pt-28 md:pt-32 pb-12 md:pb-16">
                ...
                <div className="relative z-10 w-full max-w-4xl mx-auto">
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-black mb-4 md:mb-6 tracking-tighter leading-[1.1] md:leading-[0.95]">
                        {service.title.toUpperCase()}
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-400 font-light max-w-2xl mx-auto leading-relaxed mb-6 md:mb-10">
                        {service.description}
                    </p>

                    {/* Long Description */}
                    {service.longDescription && (
                        <div className="max-w-3xl mx-auto p-5 md:p-8 rounded-2xl bg-white/[0.02] border border-white/5 backdrop-blur-sm text-left mb-6 md:mb-10">
                    ...
                    {service.highlightMetric && (
                        <div className="max-w-xs mx-auto text-center mt-4 md:mt-6">
                            <div className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-500 mb-1 md:mb-2">
                                {service.highlightMetric}
                            </div>
            ...
            {service.benefits && service.benefits.length > 0 && (
                <section className="bg-[#0a0a0a] py-14 md:py-20 px-5 md:px-12 relative border-t border-b border-white/5">
                    <div className="w-full max-w-6xl mx-auto">
                        <h2 className="text-[10px] sm:text-xs tracking-[0.3em] text-blue-500 font-bold mb-3 md:mb-4">THE ADVANTAGE</h2>
                        <h3 className="text-2xl sm:text-3xl md:text-5xl font-black mb-8 md:mb-12 tracking-tighter">WHY IT MATTERS</h3>
            ...
            {service.techStack && service.techStack.length > 0 && (
                <section className="bg-[#050505] py-14 md:py-20 px-5 md:px-12 relative border-b border-white/5">
                    <div className="w-full max-w-6xl mx-auto text-center">
                        <h2 className="text-[10px] sm:text-xs tracking-[0.3em] text-blue-500 font-bold mb-3 md:mb-4">TEARDOWN</h2>
                        <h3 className="text-2xl sm:text-3xl md:text-5xl font-black mb-8 md:mb-12 tracking-tighter">OUR ARSENAL</h3>
            ...
            <section className="bg-[#050505] py-14 md:py-20 px-5 md:px-12 relative">
                <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    <div>
                        ...
                        <h3 className="text-2xl sm:text-3xl md:text-5xl font-black mb-6 md:mb-8 tracking-tighter">WHAT WE DELIVER</h3>

                        <div className="flex flex-col gap-3 md:gap-4">
                            {service.features.map((feature, idx) => (
                                <div key={idx} className="flex items-start gap-3 md:gap-4 p-4 md:p-6 rounded-xl md:rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
                                    <CheckCircle2 className="text-blue-500 mt-0.5 shrink-0 w-5 h-5 md:w-6 md:h-6" />
                                    <div>
                                        <h4 className="text-base md:text-xl font-bold mb-0.5 md:mb-1">{feature}</h4>
                    ...
                    {service.process && service.process.length > 0 && (
                        <div>
                            ...
                            <h3 className="text-2xl sm:text-3xl md:text-5xl font-black mb-6 md:mb-8 tracking-tighter">OUR PROCESS</h3>

                            <div className="relative border-l border-white/10 ml-3 md:ml-4 py-3 md:py-4 space-y-8 md:space-y-12">
                                {service.process.map((step, idx) => (
                                    <div key={idx} className="relative pl-6 md:pl-8">
                                        ...
                                        <p className="text-gray-400 text-sm md:text-base font-light">{step.description}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            {/* Next Expertise CTA */}
            <section className="bg-[#050505] py-10 md:py-16 px-5 md:px-12 border-t border-white/5">
